...
class PushBots
{
	...
	public function __construct() {
		...
		$payloadData = array("largeIcon" => "http://www.ask-oracle.com/wp-content/uploads/2015/12/icon.png", "goto" => "http://www.ask-oracle.com/horoscope/weekly/");
		$this->pushData['payload'] = $payloadData;
		$this->pushData['alias'] = 'test';
		$this->pushData['platform'] = 1;
		*/
	}
